      ...
      <div className="relative bg-gradient-ocean py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            />
            <h1 className="text-4xl md:text-5xl font-bold text-white">NCP & Mare</h1>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="font-semibold">120+ Yachten</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <h2 className="text-3xl font-bold mb-4">Über NCP & Mare</h2>
            <p className="text-lg leading-relaxed mb-6">
              NCP & Mare ist ein etablierter Yachtcharter-Partner mit Fokus auf die kroatische Adria. 
              Das Unternehmen bietet eine große Auswahl moderner Yachten und professionellen Service.
            </p>
          </div>
