        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="font-semibold">Weltweit</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <ul className="text-lg leading-relaxed mb-6 list-disc list-inside">
              <li className="mb-2"><strong>Kroatien:</strong> Schwerpunktland mit &gt;350 Yachten auf 15 Basen (Istrien, Nord-/Mitteldalmatien, Split/Trogir, Dubrovnik).</li>
              <li className="mb-2"><strong>Griechenland:</strong> Basen u. a. Athen/Lavrion, Lefkas, Korfu; 2025 zusätzlich Kavala.</li>
              <li className="mb-2"><strong>Italien:</strong> Castellamare die Stabia</li>
