      ...
      <div className="relative bg-gradient-ocean py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Istion Yachting</h1>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <p className="text-lg leading-relaxed mb-6">
              Istion Yachting ist einer der führenden Yachtcharter-Anbieter in Griechenland mit über 30 Jahren Erfahrung. 
              Das Unternehmen bietet eine umfangreiche Flotte und exzellenten Service in den griechischen Gewässern.
            </p>
          </div>
