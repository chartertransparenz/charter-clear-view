    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative bg-gradient-ocean py-20">
        <div className="container mx-auto px-4">
          <Link to="/yachtcharter-partner/" className="inline-flex items-center text-white/90 hover:text-white mb-4 transition-colors"><ArrowLeft className="w-4 h-4 mr-2" />Zurück zu allen Partnern</Link>
          <div className="flex items-center gap-6 mb-6">
            <img src="/media/partner/kiriacoulis.svg" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/media/partner/placeholder.svg'; }} alt="Kiriacoulis Mediterranean" className="w-32 h-auto bg-white p-4 rounded-lg" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Kiriacoulis Mediterranean</h1>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card><CardContent className="p-6 text-center"><Ship className="w-8 h-8 mx-auto mb-2 text-primary" /><p className="text-sm text-muted-foreground mb-1">Flotte</p><p className="font-semibold">180+ Yachten</p></CardContent></Card>
            <Card><CardContent className="p-6 text-center"><Anchor className="w-8 h-8 mx-auto mb-2 text-primary" /><p className="text-sm text-muted-foreground mb-1">Seit</p><p className="font-semibold">1964</p></CardContent></Card>
          </div>
          <div className="prose prose-lg max-w-none mb-12">
            <h2 className="text-3xl font-bold mb-4">Über Kiriacoulis Mediterranean</h2>
            <p className="text-lg leading-relaxed">Kiriacoulis Mediterranean ist einer der traditionsreichsten Yachtcharter-Anbieter in Griechenland mit über 60 Jahren Erfahrung.</p>
          </div>
