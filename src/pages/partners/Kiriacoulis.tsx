      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <p className="text-lg leading-relaxed mb-4">Der Kern von Kiriacoulis liegt in <Link to="/reviere/mittelmeer/griechenland" className="text-primary hover:text-primary/80 underline transition-colors">Griechenland</Link>. Von Athen/Alimos und Lavrion starten Sie in den <Link to="/reviere/mittelmeer/griechenland/athen-saronischer-golf" className="text-primary hover:text-primary/80 underline transition-colors">Saronischen Golf</Link> und die <Link to="/reviere/mittelmeer/griechenland/kykladen" className="text-primary hover:text-primary/80 underline transition-colors">Kykladen</Link>, ab Lefkas und Korfu erschließen sich die ruhigen Gewässer des <Link to="/reviere/mittelmeer/griechenland/ionische-inseln" className="text-primary hover:text-primary/80 underline transition-colors">Ionischen Meers</Link>, während Kos und Rhodos die <Link to="/reviere/mittelmeer/griechenland/dodekanes" className="text-primary hover:text-primary/80 underline transition-colors">Dodekanes</Link> öffnen. Ergänzend unterhält Kiriacoulis seit Jahren Basen in weiteren Mittelmeer-Ländern, darunter <Link to="/reviere/mittelmeer/kroatien" className="text-primary hover:text-primary/80 underline transition-colors">Kroatien</Link>, <Link to="/reviere/mittelmeer/italien" className="text-primary hover:text-primary/80 underline transition-colors">Italien</Link>, <Link to="/reviere/mittelmeer/malta" className="text-primary hover:text-primary/80 underline transition-colors">Malta</Link> und <Link to="/reviere/mittelmeer/montenegro" className="text-primary hover:text-primary/80 underline transition-colors">Montenegro</Link>. Diese Breite erlaubt flexible Routenentscheidungen: kurze Familienetappen im Westen, meltemige Sprünge über die <Link to="/reviere/mittelmeer/griechenland/kykladen" className="text-primary hover:text-primary/80 underline transition-colors">Kykladen</Link>, Inselhüpfen mit Kulturprogramm oder zwei Wochen mit Revierwechsel – jeweils mit demselben organisatorischen Standard.</p>
