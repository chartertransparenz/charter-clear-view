      ...
      <div className="relative bg-gradient-ocean py-20">
        <div className="container mx-auto px-4">
          <Link to="/yachtcharter-partner/" className="inline-flex items-center text-white/90 hover:text-white mb-4 transition-colors">
            <ArrowLeft className="w-4 h-4 mr-2" />Zurück zu allen Partnern
          </Link>
          <div className="flex items-center gap-6 mb-6">
            <img src="/media/partner/five-seasons-yachting.svg" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/media/partner/placeholder.svg'; }} alt="Five Seasons Yachting" className="w-32 h-auto bg-white p-4 rounded-lg" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Five Seasons Yachting</h1>
          </div>
        </div>
      </div>
