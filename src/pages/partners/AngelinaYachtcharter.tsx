        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-6 mb-6">
            <img 
              ...
              alt="Angelina Yachtcharter" 
              className="w-32 h-auto bg-white p-4 rounded-lg"
            />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Angelina Yachtcharter</h1>
          </div>
          <p className="text-xl text-white/90 max-w-2xl">Premium Yachtcharter mit persönlichem Service</p>
        </div>
      </div>
