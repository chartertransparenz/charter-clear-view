        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-6 mb-6">
            <img 
              ...
              alt="Croatia Yachting" 
              className="w-32 h-auto bg-white p-4 rounded-lg"
            />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Croatia Yachting</h1>
          </div>
          <p className="text-xl text-white/90 max-w-2xl">Ihr Spezialist für Yachtcharter an der kroatischen Adria</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="font-semibold">150+ Yachten</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="font-semibold">1985</p>
              </CardContent>
            </Card>
          </div>
