      ...
      <div className="relative bg-gradient-ocean py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-6 mb-6">
            <img src="/media/partner/navigare-yachting.svg" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/media/partner/placeholder.svg'; }} alt="Navigare Yachting" className="w-32 h-auto bg-white p-4 rounded-lg" />
            <h1 className="text-4xl md:text-5xl font-bold text-white">Navigare Yachting</h1>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <h2 className="text-3xl font-bold mb-4">Über Navigare Yachting</h2>
            <p className="text-lg leading-relaxed">Navigare Yachting ist ein internationaler Yachtcharter-Anbieter mit breitem Netzwerk und erstklassigem Service.</p>
          </div>
