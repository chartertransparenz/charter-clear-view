...
const LeewardIslands = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src="/lovable-uploads/0d4c42e2-59bd-4dcb-b526-875ab1f536b0.png" alt="Leeward Inseln - Panoramablick über türkisfarbene Buchten mit Segelbooten" className="w-full h-full object-cover" />
