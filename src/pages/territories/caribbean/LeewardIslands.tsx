...
const LeewardIslands = () => {
  ...
  const quickFacts = [{
    icon: MapPin,
    label: "Lage",
    value: "Nördliche Kleine Antillen"
  }, {
    icon: Calendar,
    label: "Beste Zeit",
    value: "Dezember-Mai"
  ...
  const highlights = ["Vielfältige Kulturen und Sprachen", "Französisches und niederländisches Flair", "Traumhafte Sandstrände", "Konstante Passatwinde", "Exzellente Gastronomie", "Duty-free Shopping", "Perfekte Segelbedingungen"];
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <Navigation />
      
      {/* Header */}
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src="/lovable-uploads/0d4c42e2-59bd-4dcb-b526-875ab1f536b0.webp" alt="Leeward Inseln - Panoramablick über türkisfarbene Buchten mit Segelbooten" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 py-3">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Leeward Islands</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
