  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Ihr 7-Tage-Törnvorschlag auf den Seychellen (ab Mahé)</h2>
            
            <div className="space-y-4">
              <div className="border-l-4 border-blue-600 pl-4">
                <h3 className="font-semibold text-gray-800">Tag 1: Ankunft & Inselzauber</h3>
                <p className="text-gray-600">Nach dem Check-in auf Mahé setzen Sie die Segel für einen kurzen Schlag zum Sainte Anne Marine National Park. Genießen Sie das erste Bad im kristallklaren Wasser und schnorcheln Sie durch die farbenfrohe Unterwasserwelt.</p>
              </div>
              
              <div className="border-l-4 border-blue-600 pl-4">
                <h3 className="font-semibold text-gray-800">Tag 2: Kurs auf Praslin</h3>
                <p className="text-gray-600">Segeln Sie nach Praslin, der Heimat des UNESCO-Welterbes Vallée de Mai. Am Nachmittag ankern Sie vor dem berühmten Anse Lazio, einem der schönsten Strände der Welt, und lassen den Tag ausklingen.</p>
              </div>
              ...
              <div className="border-l-4 border-blue-600 pl-4">
                ...
                <p className="text-gray-600">Beginnen Sie die Rückreise in Richtung Mahé. Legen Sie einen entspannten Stopp an einer der schönen Buchten von Silhouette Island oder einer abgelegenen Bucht an der Nordwestküste Mahés ein.</p>
              </div>
              
              <div className="border-l-4 border-blue-600 pl-4">
                <h3 className="font-semibold text-gray-800">Tag 7: Abschied vom Paradies</h3>
                <p className="text-gray-600">Nach einem letzten Frühstück an Bord segeln Sie zurück zu Ihrer Charterbasis auf Mahé und treten die Heimreise an – erfüllt von unvergesslichen Eindrücken.</p>
              </div>
            </div>
