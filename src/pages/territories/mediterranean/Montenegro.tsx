...
const Montenegro = () => {
  ...
  const quickFacts = [
    { icon: MapPin, label: "Lage", value: "Adriatisches Meer" },
    { icon: Calendar, label: "Beste Zeit", value: "Mai-Oktober" },
    { icon: Users, label: "Geeignet für", value: "Erfahrene Segler" },
    { icon: Anchor, label: "Besonderheit", value: "Dramatische Fjordlandschaft" }
  ];
  ...
  const highlights = [
    ...
    "Unberührte Natur",
    "Authentische Balkanbee",
    "Kristallklares Adriawasser",
