...
const Malta = () => {
  ...
  const quickFacts = [
    ...
    { icon: Anchor, label: "Besonderheit", value: "Kompakte Inselgruppe" }
  ];
  ...
  const highlights = [
    ...
    "Kompakte Segelreviere",
    "Ganzjährig mildes Klima",
    "UNESCO-Weltkulturerbe Valletta",
    "Authentische mediterrane Atmosphäre",
    "Exzellente Sicherheitsstandards"
  ];
