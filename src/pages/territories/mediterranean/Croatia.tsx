        ...
        <div className="max-w-4xl mx-auto mb-16 space-y-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">Reviercharakter & Besonderheiten:</h5>
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">Hauptorte & Marinas:</h5>
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              <h5 className="text-lg font-semibold mb-3 text-black">Highlights & Routenvorschläge:</h5>
              <ul className="list-disc pl-6 space-y-2 text-black">
            ...
            <div className="border border-gray-300 p-4 rounded-lg mb-6">
              <p className="text-black"><strong>Für wen geeignet?</strong> Einsteiger, Familien, Genießer, Kulturinteressierte, Crews mit Lust auf kurze Schläge und viele Landgänge.</p>
            </div>
            ...
            <div className="border border-gray-300 p-4 rounded-lg mb-6">
              <p className="text-black"><strong>Für wen geeignet?</strong> Alle Erfahrungsstufen, Familien, Natur- und Tierliebhaber, Crews, die Abwechslung zwischen Inseln und Festland suchen.</p>
            </div>
            ...
            <div className="border border-gray-300 p-4 rounded-lg mb-6">
              <p className="text-black"><strong>Für wen geeignet?</strong> Einsteiger, Familien, Genießer, Naturfreunde, Crews mit Lust auf Inselhopping, Nationalparks und Kultur.</p>
            </div>
            ...
            <div className="border border-gray-300 p-4 rounded-lg mb-6">
              <p className="text-black"><strong>Für wen geeignet?</strong> Alle Erfahrungsstufen, Familien, Genießer, sportliche Crews, Nachtschwärmer, Kulturinteressierte.</p>
            </div>
            ...
            <div className="border border-gray-300 p-4 rounded-lg mb-8">
              <p className="text-black"><strong>Für wen geeignet?</strong> Erfahrene Skipper, Crews mit Lust auf längere Schläge, Kultur- und Naturfans, Nachtschwärmer.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="border border-gray-300 p-6 rounded-lg">
                ...
                <p className="mb-4 text-black">Zahlreiche internationale Flughäfen entlang der Küste werden von Deutschland, Österreich und der Schweiz aus direkt angeflogen. Die wichtigsten Zielflughäfen für unsere Chartergäste sind:</p>
                ...
                <p className="text-sm text-black">Vom Flughafen zur Marina organisieren wir gerne einen zuverlässigen Transfer für Sie und Ihre Crew.</p>
              </div>

              <div className="border border-gray-300 p-6 rounded-lg">
                <h4 className="text-lg font-semibold mb-3 text-black">Per PKW</h4>
                <p className="text-black">Kroatien ist aus Süddeutschland, Österreich und der Schweiz bequem mit dem Auto erreichbar. Dies bietet den Vorteil, mehr Gepäck und persönlichen Proviant mitnehmen zu können. Die meisten Marinas bieten sichere Parkmöglichkeiten für die Dauer Ihres Törns.</p>
              </div>
            </div>
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              ...
              <p className="text-black mb-3">Die ACI (Adriatic Croatia International Club) ist die größte Marina-Kette im Mittelmeer und betreibt zahlreiche hochmoderne Marinas entlang der gesamten kroatischen Küste. Sie bieten umfassenden Service (Wasser, Strom, Sanitäranlagen, WLAN, Werften, Restaurants, Geschäfte).</p>
              
              <h5 className="font-semibold mb-2 text-black">Vielfalt der Charterbasen:</h5>
              <p className="text-black mb-3">Neben den ACI Marinas gibt es viele weitere private Marinas und Charterstützpunkte in allen Regionen.</p>
              
              <h5 className="font-semibold mb-2 text-black">Umfassende Flotte:</h5>
              <p className="text-black mb-2">Unsere Flotte umfasst eine große Auswahl an Charteryachten für jeden Anspruch und jede Crewgröße:</p>
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              <h4 className="text-lg font-semibold mb-3 text-black">Highlights nach Regionen</h4>
              <ul className="list-disc pl-6 space-y-2 text-black">
              ...
              <h5 className="font-semibold mt-4 mb-2 text-black">Ankerplätze & Buchten:</h5>
              <p className="text-black mb-2">Kroatien ist berühmt für seine unzähligen, oft geschützten Ankerbuchten mit kristallklarem Wasser. Viele bieten Mooringbojen, andere erlauben das freie Ankern.</p>
              
              <h5 className="font-semibold mb-2 text-black">Nautische Highlights:</h5>
              <p className="text-black mb-2">Die Erkundung von Höhlen (z.B. Blaue Grotte auf Biševo), das Schnorcheln und Tauchen in der klaren Adria, das Entdecken von versunkenen Schiffen oder das Beobachten von Delfinen.</p>
              
              <h5 className="font-semibold mb-2 text-black">Landaktivitäten:</h5>
              <p className="text-black">Besuche von historischen Altstädten, Wanderungen in Nationalparks, Weinproben auf den Inseln, das Genießen der lokalen Küche in Konobas und das Erleben von traditionellen Festen.</p>
            </div>
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-6">
              <h4 className="text-lg font-semibold mb-3 text-black">Wichtige Vorschriften</h4>
              <ul className="list-disc pl-6 space-y-2 text-black">
            ...
            <div className="border border-gray-300 p-6 rounded-lg mb-8 text-center">
              <h4 className="text-xl font-bold mb-4 text-black">Sind Sie bereit, die Segel zu setzen und Kroatien zu entdecken?</h4>
              <p className="text-black mb-4">Fordern Sie jetzt Ihr unverbindliches Angebot für einen Yachtcharter in Kroatien an! Durchstöbern Sie unsere Online-Yachtsuche oder kontaktieren Sie unser Expertenteam direkt. Wir beraten Sie persönlich und finden die ideale Yacht im perfekten Revier für Sie.</p>
            </div>
          </div>
        </div>
