      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Segeln in Kroatien</h2>
            <p className="text-lg text-gray-600 mb-4">
              Kroatien ist das beliebteste Segelrevier Europas! Mit über 1.200 Inseln, 
              kristallklarem Wasser und einer hervorragenden Infrastruktur bietet das 
              Land ideale Bedingungen für unvergessliche Segeltörns.
            </p>
            <p className="text-lg text-gray-600">
              Von den geschützten Buchten Istriens über die legendären Kornaten bis 
              zur historischen Perle Dubrovnik - Kroatien vereint perfekte 
              Segelbedingungen mit reicher Kultur und Gastfreundschaft.
            </p>
          </div>
        </div>
