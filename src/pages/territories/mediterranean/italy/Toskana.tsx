        ...
        <div className="max-w-4xl mx-auto mb-12">
          <Card className="shadow-lg">
            <CardContent className="p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Segeln an der toskanischen Küste</h2>
              <p className="text-lg text-gray-600 mb-4">
                Die toskanische Küste vereint das Beste aus zwei Welten: die weltberühmte 
                Kultur der Toskana mit traumhaften Segelrevieren im Mittelmeer. Höhepunkt 
                ist die bezaubernde Insel Elba, die mit kristallklarem Wasser und 
                charmanten Häfen lockt.
              </p>
              <p className="text-lg text-gray-600">
                Kurze Segeldistanzen machen die Region ideal für entspannte Wochenendtörns, 
                während die Nähe zu den toskanischen Kulturstädten perfekte Kombination 
                aus Segeln und Landexkursionen ermöglicht.
              </p>
            </CardContent>
          </Card>
        </div>
