...
const Slovenia = () => {
  ...
  const highlights = [
    "Kompakte, überschaubare Küste",
    "Authentische Adriaatmosphäre",
    "Ausgezeichnete Weinregion",
    "Kurze Distanzen zu Kroatien/Italien",
    "Familienfreundliche Reviere",
    "Hochwertige Marina-Infrastruktur",
    "Grüne, unberührte Hinterländer"
  ];
