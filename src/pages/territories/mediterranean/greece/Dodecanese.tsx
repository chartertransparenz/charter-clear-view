...
const Dodecanese = () => {
  ...
  const quickFacts = [
    { icon: MapPin, label: "Lage", value: "Südostägäis" },
    { icon: Calendar, label: "Beste Zeit", value: "April-November" },
    { icon: Users, label: "Geeignet für", value: "Erfahrene Segler" },
    { icon: Anchor, label: "Besonderheit", value: "Längere Distanzen" }
  ];

  const cities = [
    "Rhodos", "Kos", "Patmos", "Leros", "Kalymnos", "Symi", "Tilos", "Karpathos"
  ];

  const highlights = [
    "UNESCO-Weltkulturerbe Rhodos",
    "Klöster und Pilgerorte",
    "Authentische griechische Kultur",
    "Längere Segeletappen",
    "Kristallklares Wasser",
    "Weniger Tourismus als Kykladen",
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Segeln im Dodekanes</h2>
            <p className="text-lg text-gray-600 mb-4">
              Die Dodekanes-Inseln im Südosten der Ägäis bieten authentisches 
              griechisches Segeln abseits der touristischen Hauptrouten. Diese 
              Inselgruppe ist perfekt für erfahrene Segler, die längere Etappen 
              und unberührte griechische Kultur suchen.
            </p>
            <p className="text-lg text-gray-600">
              Von der mittelalterlichen Stadt Rhodos über das spirituelle Patmos 
              bis hin zu versteckten Perlen wie Symi - der Dodekanes verzaubert 
              mit seiner Authentizität und Vielfalt.
            </p>
          </div>
        </div>
