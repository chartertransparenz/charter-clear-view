  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Greek Subregions Navigation */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Griechische Segelreviere entdecken</h2>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2 mb-3">
                    ...
                    <Badge variant="outline">Anfänger</Badge>
                  </div>
                  <p className="text-sm text-muted-foreground mb-3">
                    Entspanntes Einstiegsrevier für Genießer und Familien mit kurzen Schlägen.
                  </p>
                  <div className="text-xs text-muted-foreground">
                    Highlights: Ägina • Poros • Hydra • Spetses
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/reviere/mittelmeer/griechenland/kykladen" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Sportliches Revier für erfahrene Segler mit starkem Meltemi-Wind.
                  </p>
                  <div className="text-xs text-muted-foreground">
                    Highlights: Mykonos • Santorini • Paros • Naxos
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/reviere/mittelmeer/griechenland/ionische-inseln" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Grünes Inselparadies für Familien mit milden Winden und türkisem Wasser.
                  </p>
                  <div className="text-xs text-muted-foreground">
                    Highlights: Korfu • Lefkas • Kefalonia • Zakynthos
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/reviere/mittelmeer/griechenland/dodekanes" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Highlights: Rhodos • Kos • Symi • Patmos
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/reviere/mittelmeer/griechenland/sporaden" className="group">
              <Card className="h-full hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Ursprüngliches Naturrevier für Ruhesuchende abseits der Touristenströme.
                  </p>
                  <div className="text-xs text-muted-foreground">
                    Highlights: Skiathos • Skopelos • Alonnisos • Skyros
                  </div>
