...
const Azores = () => {
  ...
  const highlights = [
    ...
    "Unberührte Natur und Kraterseen",
    "Authentische portugiesische Kultur",
    "Walbeobachtung und Delfine",
    "Wenig befahrene Gewässer",
    "Thermalbäder und heiße Quellen",
    "Anspruchsvolles Hochsee-Segeln"
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Segeln in den Azoren</h2>
            <p className="text-lg text-gray-600 mb-4">
              Die Azoren sind ein einzigartiges Segelerlebnis für abenteuerlustige 
              Segler im Herzen des Atlantiks. Diese neun vulkanischen Inseln bieten 
              spektakuläre Landschaften, unberührte Natur und eine authentische 
              portugiesische Kultur fernab der Touristenmassen.
            </p>
            <p className="text-lg text-gray-600">
              Mit ihren Kraterseen, heißen Quellen und der reichhaltigen Meeresfauna 
              sind die Azoren perfekt für erfahrene Segler, die echte Abenteuer und 
