...
const USAEastCoast = () => {
  ...
  const quickFacts = [{
    ...
    value: "Newport, Boston, Annapolis"
  }, {
    icon: Calendar,
    label: "Beste Zeit",
    value: "Mai-Oktober"
  ...
  const sailingHighlights = ["Legendäre amerikanische Segeltradition", "Anspruchsvolle Gewässer mit Gezeiten", "Historische Häfen und Städte", "Erstklassige Segelschulen und Clubs", "Spektakuläre Herbstfarben (Fall Foliage)", "Martha's Vineyard und Nantucket", "America's Cup Heritage"];
  const popularRoutes = ["Newport - Martha's Vineyard - Nantucket", "Boston - Cape Cod - Provincetown", "Annapolis - St. Michaels - Oxford", "Newport - Block Island - Mystic"];
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src={atlantic} alt="USA Ostküste Yacht Charter" className="w-full h-full object-cover" />
