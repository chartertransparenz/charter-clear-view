...
const Bahamas = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <Meta 
        ...
        ogImage={m.ogImage}
      />
      <JsonLd json={BREADCRUMB_CARIBBEAN.bahamas} />
      <Navigation />
      
      {/* Header */}
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src="/lovable-uploads/72646193-1d57-47bd-adcd-0db66bb17fb7.webp" alt="Bahamas Yacht Charter" className="w-full h-full object-cover" />
