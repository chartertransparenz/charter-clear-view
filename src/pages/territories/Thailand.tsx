...
const Thailand = () => {
  ...
  const highlights = ["Exotische Felseninseln-Kulisse", "Günstige Charterpreise", "Reiche Kultur & Küche", "Warmes, tropisches Wasser", "Versteckte Lagunen", "Freundliche Bevölkerung", "Beste Reisezeit Nov-Apr", "Kombination Segeln & Landprogramm"];
  const routes = ["Phuket - Phang Nga Bay", "James Bond Island - Koh Yao", "Krabi - Phi Phi Islands", "Langkawi - Penang"];
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <Navigation />
      {/* Header */}
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src="/lovable-uploads/b8d7c49e-e173-4854-b08c-755db093505f.png" alt="Thailand Segelrevier" className="w-full h-full object-cover" />
        ...
        <div className="mb-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <div className="grid gap-3 md:grid-cols-2">
              {routes.map((route, index) => <div key={index} className="flex items-center">
