...
const Holland = () => {
  ...
  const quickFacts = [
    { icon: MapPin, label: "Lage", value: "Niederländische Nordsee & IJsselmeer" },
    { icon: Calendar, label: "Beste Zeit", value: "Mai-September" },
    { icon: Users, label: "Geeignet für", value: "Erfahrene Segler" },
    { icon: Anchor, label: "Besonderheit", value: "Extreme Gezeiten, großes Binnengewässer" }
  ];

  const highlights = [
    "IJsselmeer - riesiges Binnengewässer",
    "Extreme Nordsee-Gezeiten bis 4m",
    "Traditionelle Segelkultur",
    "Historische Hafenstädte",
    "Wattenmeer UNESCO-Welterbe",
    "Ausgezeichnete Infrastruktur",
    "Herausfordernde Tidenreviere"
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Marinas */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Segelreviere</h2>
