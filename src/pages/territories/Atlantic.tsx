...
const atlantic = "/lovable-uploads/ff7dc4cb-f11b-4982-bae9-e7ac8218165e.webp";
const Atlantic = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-64 md:h-96 overflow-hidden mt-20">
        <img src="/lovable-uploads/ff7dc4cb-f11b-4982-bae9-e7ac8218165e.webp" alt="Atlantik" className="w-full h-full object-cover" />
