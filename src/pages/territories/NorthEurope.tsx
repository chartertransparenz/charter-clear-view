...
import { ArrowLeft, MapPin, Mountain, Anchor } from "lucide-react";
import { Link } from "react-router-dom";
import balticSea from "@/assets/baltic-sea.jpg";

const NorthEurope = () => {
  const regions = [
    { name: "Schweden", areas: ["Schärengarten Stockholm", "Westküste"] },
    { name: "Dänemark", areas: ["Südsee", "Inselwelt"] },
    { name: "Deutschland", areas: ["Ostsee", "Mecklenburg", "Kieler Bucht"] },
    { name: "Norwegen", areas: ["Fjorde"] },
    { name: "Niederlande", areas: ["Ijsselmeer", "Friesland"] }
  ];
      ...
      <div className="relative h-64 md:h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <Badge className="mb-4 bg-sunset text-white">🧭 Nordeuropa</Badge>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Nord- & Ostsee</h1>
            <p className="text-xl max-w-2xl">
              Beeindruckende Landschaften und sichere Navigation
            </p>
          </div>
        </div>
        <Link 
          ...
          <Card className="shadow-elegant">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-ocean-dark">
                ...
                Nordeuropäische Schönheit
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-lg text-muted-foreground">
                Kühle, aber landschaftlich beeindruckende Reviere mit sicherer Navigation. 
                Ideal für erfahrene Crews, die die Schönheit Nordeuropas entdecken möchten.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="bg-gradient-ocean text-white shadow-elegant">
            <CardContent className="p-8">
              ...
              <p className="mb-6 text-white/90 max-w-2xl mx-auto">
                Erleben Sie die landschaftliche Schönheit Nordeuropas mit unseren 
                erfahrenen Crews und erstklassigen Yachten.
              </p>
