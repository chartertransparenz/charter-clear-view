...
const Maldives = () => {
  ...
  const quickFacts = [
    { icon: MapPin, label: "Lage", value: "Zentraler Indischer Ozean" },
    { icon: Calendar, label: "Beste Zeit", value: "November-April" },
    { icon: Users, label: "Geeignet für", value: "Luxus- und Katamarancharter" },
    { icon: Anchor, label: "Atolls", value: "26 Atolls, 1.200 Inseln" }
  ];
  ...
  const highlights = [
    "Traumhafte Luxus-Resorts",
    "Kristallklare, türkisfarbene Lagunen",
    "Perfekt für Katamaran-Charter",
    "Weltklasse Schnorcheln und Tauchen",
    "Absolute Privatsphäre und Ruhe",
    "Overwater-Bungalows",
    "Paradies für Honeymooner"
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Segeln in den Malediven</h2>
            <p className="text-lg text-gray-600 mb-4">
              Die Malediven verkörpern den Traum vom perfekten tropischen Paradies. 
              Mit 26 Atolls und über 1.200 Inseln bieten sie das ultimative 
              Luxus-Segelerlebnis mit kristallklaren, türkisfarbenen Lagunen und 
              einigen der schönsten Overwater-Bungalows der Welt.
            </p>
            <p className="text-lg text-gray-600">
              Perfekt für Katamaran-Charter und Luxusyachten, bieten die Malediven 
              absolute Privatsphäre, Weltklasse-Resorts und eine unvergleichliche 
              Unterwasserwelt - ideal für Honeymooner und Luxusliebhaber.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-8 rounded-lg shadow-lg text-center">
            <h3 className="text-2xl font-bold mb-4">
              Bereit für die Malediven?
            </h3>
            <p className="mb-6 text-blue-100">
              Erfüllen Sie sich den Traum vom ultimativen Luxus-Segelparadies 
              mit türkisfarbenen Lagunen und Overwater-Bungalows.
            </p>
            <CharterRequestForm>
