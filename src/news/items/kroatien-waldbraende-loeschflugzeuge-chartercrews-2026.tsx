...
const content = (
  <div>
    ...
    <p>
      ...
      Trockenheit und starkem Wind können sie sich innerhalb weniger Stunden über
      große Flächen ausbreiten und Orte direkt am Meer erreichen. Mitte August 2026
      brannte es gleichzeitig bei Omiš und auf der Halbinsel Pelješac. Für
      Chartercrews in diesem Revier entsteht dabei eine spezifische Situation:
      Löschflugzeuge schöpfen ihr Wasser direkt aus der Adria – oft in Buchten und
      Gewässern, in denen zur selben Zeit auch Yachten unterwegs sind.
    </p>

    <h2>Lage im August 2026</h2>
    <p>
    ...
    <p>
      Canadair CL-415-Wasserbomber schöpfen ihr Löschwasser direkt aus dem Meer –
      häufig in unmittelbarer Nähe zum Brandgebiet, also direkt vor dalmatinischen
      Küstenstreifen und in besuchten Buchten. Das Manöver läuft schnell und mit
      hohem Tempo ab: Das Flugzeug berührt bei rund 150 km/h die Wasseroberfläche
      und nimmt in etwa zehn Sekunden fast sechs Tonnen Wasser durch Schöpfklappen
      im Rumpf auf, bevor es wieder abhebt. Der eigentliche Schöpfvorgang
      erstreckt sich über eine Strecke von rund 400 Metern.
    </p>
    <p>
      Bevor ein Canadair auf Schöpfkurs geht, fliegt die Besatzung einen niedrigen
      Aufklärungspass über der geplanten Schöpfachse – üblicherweise auf 30 bis
      50 Meter Höhe. Dieser Tiefüberflug ist ein klares Signal: Das Flugzeug wird
      gleich auf diesem Kurs Wasser schöpfen. Boote auf der Wasseroberfläche, die
    ...
    <p>
      ...
      sich selbst, sondern können den gesamten Löscheinsatz verzögern oder unmöglich
      machen. Im Juli 2026 hatte die Gemeinde Blato auf Korčula bereits explizit
...
export const kroatienWaldbraendeLoeschflugzeugeChartercrews2026: NewsItem = {
  content,
  slug: "kroatien-waldbraende-loeschflugzeuge-chartercrews-2026",
  title:
  ...
  canonical_topic_key: "kroatien_waldbraende_adria_2026",
  seo_title:
  ...
  region_links: [
    ...
    {
      label: "Sicherheitsregeln Kroatien",
