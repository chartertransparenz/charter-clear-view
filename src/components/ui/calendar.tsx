    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-9 w-9 bg-transparent p-0 opacity-70 hover:opacity-100 border-muted hover:border-primary transition-all"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-12 h-12 font-semibold text-sm flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-12 w-12 p-0 font-medium aria-selected:opacity-100 text-sm hover:bg-accent/50 transition-colors"
        ),
