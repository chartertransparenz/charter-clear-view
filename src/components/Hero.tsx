...
const Hero = () => {
  ...
  return <section id="start" className="relative h-screen flex items-center justify-center overflow-hidden" style={{marginTop: '80px'}} onLoad={() => console.log('Hero section with 80px margin, total height: calc(100vh + 80px)')}>
