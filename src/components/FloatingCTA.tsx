...
const FloatingCTA = () => {
  ...
  return (
    <div className={`fixed top-20 right-4 md:right-8 z-40 transition-all duration-300 ${
      ...
      <CharterRequestForm>
        <button className="group relative w-16 h-16 bg-gradient-ocean backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-elegant animate-float border-2 border-white/20">
