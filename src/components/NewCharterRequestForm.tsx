...
// Extract FormContent as standalone component to prevent remounting
const FormContent = ({ form, onSubmit, isSubmitting }: FormContentProps) => (
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="border-t pt-6 mt-8">
              ...
              <div className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          {...field} 
                          placeholder="Weitere Informationen zu Ihren Wünschen..."
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel className="text-sm font-medium text-ocean-dark">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-14 text-lg font-semibold bg-gradient-ocean hover:opacity-90 transition-opacity"
                ...
                <p className="text-center text-sm text-gray-600">
                  Nach dem Absenden erhalten Sie innerhalb von 24 Stunden ein personalisiertes Angebot per E-Mail.
                </p>
              </div>
            </div>
          </form>
...
const NewCharterRequestForm = ({ children, isOpen, onOpenChange }: NewCharterRequestFormProps) => {
  ...
  }, [form, setDialogOpen, onOpenChange]);
    ...
    return (
      <Dialog open={isDialogOpen} onOpenChange={handleOpenChange}>
        ...
        <DialogContent className="max-w-5xl w-[95vw] max-h-[95vh] overflow-y-auto p-0 bg-white">
          <FormContent form={form} onSubmit={onSubmit} isSubmitting={isSubmitting} />
        </DialogContent>
      </Dialog>
    );
  }
